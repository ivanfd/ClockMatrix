...
#define TX_DS             5     // Перивання выдбулося по відправлених даних TX FIFO. Встановлюэться, коли пакет, переданий. Якщо AUTO_ACK активовано, цей біт встановлюється лише тоді, коли є ACK отримано.
